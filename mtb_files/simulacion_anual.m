...
% Aqui ponemos una serie de posibles deviaciones para escoger

% desviaciones_nominales = [0.5e-3  0.5e-3  0.5e-3  3e-3;...
%                           0.5e-3  0.5e-3  3e-3    0.5e-3 ;...
%                           0.5e-3  3e-3    0.5e-3  0.5e-3 ;...
%                           3e-3    0.5e-3  0.5e-3  0.5e-3 ];
%
% desviaciones_nominales = [ 3e-3    3e-3    3e-3    3e-3;...
%                           0.5e-3  0.5e-3  0.5e-3  3e-3;...
%                           0.5e-3  0.5e-3  3e-3    0.5e-3 ;...
%                           0.5e-3  3e-3    0.5e-3  0.5e-3 ;...
%                           3e-3    0.5e-3  0.5e-3  0.5e-3 ];
%
...
%                           3e-3 0    0    0];
%
% desviaciones_nominales = [0 0 1e-3  0;...
%                           0 0 3e-3  0;...
%                           0 0 5e-3  0;...
%                           0 0 10e-3 0];
%
% desviaciones_nominales = [1e-3  0 0 0;...
%                           3e-3  0 0 0;...
%                           5e-3  0 0 0;...
%                           10e-3 0 0 0];
%
% desviaciones_nominales = [0 1e-3  0 0;...
%                           0 3e-3  0 0;...
%                           0 5e-3  0 0;...
%                           0 10e-3 0 0];
%
% desviaciones_nominales = [0 0 0 1e-3;...
%                           0 0 0 3e-3;...
%                           0 0 0 5e-3;...
%                           0 0 0 10e-3];
%
...
for desviaciones = 1:size(desviaciones_nominales,1)
    ...
    for h = 1:size(heliostatos, 1)
        ...
        save([archivos_salida, int2str(h), des_str], 'TNE', 'TNX', 'TNY');
    end
end